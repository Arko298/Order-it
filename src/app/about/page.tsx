...
export default function About(){
    return(
        <section
      className="overflow-hidden bg-white pb-12 pt-20 lg:pb-[90px] lg:pt-[120px] dark:bg-dark"
    >
        ...
        <div className="-mx-4 flex flex-wrap items-center justify-between">
          ...
          <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
            <div className="mt-10 lg:mt-0">
              ...
              <h2
                className="mb-5 text-3xl font-bold text-dark sm:text-[40px]/[48px] dark:text-white"
              >
